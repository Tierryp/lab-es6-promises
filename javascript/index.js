    ...
    getInstruction("mashedPotatoes", 2, (step3) => {
      ...
      getInstruction("mashedPotatoes", 3, (step4) => {
        ...
        getInstruction("mashedPotatoes", 4, (step5) => {
          ...
          getInstruction("mashedPotatoes", 3, (step6) => {
            document.querySelector(
              "#mashedPotatoes"
...
// Promise.all(`${step[i]}`).then((values) => console.log("values", values));
// }
// document.querySelector("#broccoliImg").removeAttribute("hidden")
// }
...
Promise.all([step1, step2, step3, step4, step5, step6, step7, step8]).then(
  (resolvedPromises) => {
    resolvedPromises.forEach((resolution) => {
      document.querySelector(
        "#brusselsSprouts"
      ).innerHTML += `<li>${resolution}</li>`;
    });
